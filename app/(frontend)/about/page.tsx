...
export default async function AboutPage() {
  ...
  return (
    <div className="p-4 flex flex-col justify-center">
      ...
      <p className="text-xl">I have been coding and practicing programming for about a year.</p>
      <p className="text-xl">I was born in 1991 in Iran and currently live in Tehran.</p>
